...
mosi_acc2 = [72.5, 74.8, 76.4, 74.5, 71.0]
mosi_f1   = [72.8, 74.0, 76.3, 72.4, 70.2]

# MOSEI 数据 [ACC2, F1]
mosei_acc2 = [74.8, 75.1, 77.4, 73.5, 72.2]
mosei_f1   = [74.2, 74.8, 76.8, 72.0, 71.9]
...
# --- 绘制图 (a) MOSI ---
ax1 = axes[0]
ax1.plot(x_indices, mosi_acc2, label='ACC2', color="#ff1f48", marker='o', linestyle='-', linewidth=2)
ax1.plot(x_indices, mosi_f1,   label='F1',   color="#0066aa", marker='s', linestyle='--', linewidth=2)
